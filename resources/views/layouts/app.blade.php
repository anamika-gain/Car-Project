<html lang="eng">
  ...
  <body id="indexpage" class="headerpin86 indexpage">
    <div style="position: relative">
          ...
          <div class="header-main">
            ...
            <div class="logo" style="">
              <a class="navbar-brand" href="/index/"
                ><img
                  src="/admin/uploaded_photos/site_logo.png?nc=2501"
                ...
                <div class="sticky-phone" style="display: none">
                  <div class="container-center">
                    ...
                    <div class="stickyLogo">
                      <!-- <a href="/index/"><img src="/admin/uploaded_photos/site_logo3.png?nc=2501" alt="Ayaan Motors Ltd"></a> -->
                    </div>
                  ...
                  <ul class="address_logo">
                    <li>
                      <a href="/" title="Ayaan Motors Ltd Homepage"
                        ><img
                          class="lazyload"
                          src="https://ayaanmotors.com/admin/uploaded_photos/site_logo2.png?nocache=135934"
                          data-src="https://ayaanmotors.com/admin/uploaded_photos/site_logo2.png?nocache=135934"
      ...
      <div id="foot-bar">
        <ul class="foot-bar">
          ...
          <li class="foot-bar_listitem">
            <a href="/find_us/#maploc" class="foot-bar_link" title="Find us"
      ...
      <style>
        ...
        #cd5_module182 .m182_left {
          aground-color: #efefef;
        }
        #all_car_features_v1 .list-ticks li:before {
          color: #999;
        }
      ...
      <!-- Cookie Notice -->
      <script src="/asset/js/cd5_cookienotice.js"></script>
    </div>
    <script
      defer=""
      id="vcLoaderScript"
    ...
    ></script>
    <!-- <div id="vcRootlXScPjMzN8g3" class="vc_root">
      <div class="sc-bdVaJa JRavo">
        <div class="notification-container notification-container-empty">
          <span></span>
        </div>
        <div class="sc-bwzfXH dlxqbR" style="">
          <p class="sc-iwsKbI euRLmD">1</p>
          <iframe
            scrolling="no"
            frameborder="0"
            title="VC Call To Action"
            style="width: 100%; height: 100%"
          ></iframe>
        </div>
        <div id="fbElement" class="sc-gqjmRU dcWceV" style="">
          <iframe
            scrolling="no"
            frameborder="0"
            title="VC Floating Button"
            style="width: 100%; height: 100%"
          ></iframe>
        </div>
      </div>
