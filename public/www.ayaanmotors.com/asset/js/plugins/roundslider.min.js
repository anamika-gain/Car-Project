    ...
    $.fn[pluginName] = function(n) {
        ...
        _tooltipEditable: function() {
            var i = this.options,
                n = this.tooltip,
                t;
            n && i.showTooltip && (i.editableTooltip ? (n.addClass("edit"), t = "_bind") : (n.removeClass("edit"), t = "_unbind"), this[t](n, "click", this._editTooltip))
        },
        _editTooltip: function() {
            var n = this.tooltip,
                i, t;
            n.hasClass("edit") && !this._isReadOnly && (i = parseFloat(n.css("border-left-width")) * 2, t = this.input = this.$createElement("input.rs-input rs-tooltip-text").css({
                height: n.outerHeight() - i,
                width: n.outerWidth() - i
            }), n.html(t).removeClass("edit").addClass("hover"), t.focus().val(this._getTooltipValue(!0)), this._bind(t, "blur", this._focusOut), this._bind(t, "change", this._focusOut))
        },
        ...
        _setHandleShape: function() {
            var t = this.options.handleShape,
                n = this._handles();
            n.removeClass("rs-handle-dot rs-handle-square"), t == "dot" ? n.addClass("rs-handle-dot") : t == "square" ? n.addClass("rs-handle-square") : this.options.handleShape = "round"
        },
        ...
        _refreshHandle: function() {
            ...
            if (typeof hSize == "string" && isNumber(hSize))
                if (hSize.charAt(0) === "+" || hSize.charAt(0) === "-") try {
                    hSize = eval(width + hSize.charAt(0) + Math.abs(parseFloat(hSize)))
                } catch (e) {
                    console.warn(e)
                } else hSize.indexOf(",") && (s = hSize.split(","), isNumber(s[0]) && isNumber(s[1]) && (w = parseFloat(s[0]), h = parseFloat(s[1]), isSquare = !1));
            isSquare && (h = w = isNumber(hSize) ? parseFloat(hSize) : width), diff = (width + this._border() - w) / 2, this._handles().css({
                height: h,
                width: w,
        ...
        _raiseEvent: function(n) {
            ...
            if (i !== t) return this["_pre" + n] = t, n == "change" && this._updatePre(), this._updateTooltip(), (n == "change" || this._bindOnDrag && n == "drag") && this._updateHidden(), this._raise(n, {
                value: t,
                preValue: i,
        ...
        _getMinusStep: function(n) {
            var t = this.options,
                ...
                i = t.step,
                r;
            return n == u ? (r = (u - f) % i, r == 0 ? i : r) : i
        },
        _getKeyValue: function(n) {
            var t = this.options,
                i = t.min,
                r = t.max;
            return this._rangeSlider ? n == "Home" ? this._active == 1 ? i : this._handle1.value : this._active == 1 ? this._handle2.value : r : n == "Home" ? i : r
        },
        ...
        _updateARIA: function(n) {
            ...
            this.bar.children().attr({
                "aria-valuenow": n
            }), i.sliderType == "range" ? (t = this._handles(), t.eq(0).attr({
                "aria-valuemin": r
            }), t.eq(1).attr({
                "aria-valuemax": u
        ...
        _processStepByValue: function(n) {
            var e = this.options,
                ...
                s = o > l,
                h, t, r, u, f, c;
            return i = s ? -i : i, h = (n - o) % i, t = n - h, r = this._limitValue(t + i), u = this._limitValue(t - i), f = s ? n <= t ? t - n < n - r ? t : r : n - t > u - n ? t : u : n >= t ? n - t < r - n ? t : r : t - n > n - u ? t : u, f = this._round(f), c = this._valueToAngle(f), {
                value: f,
                angle: c
            }
        },
        ...
        _limitValue: function(n) {
            var u = this.options,
                ...
                i = u.max,
                r = t > i;
            return (!r && n < t || r && n > t) && (n = t), (!r && n > i || r && n < i) && (n = i), n
        },
        _angleToValue: function(n) {
            var t = this.options,
                i = t.min,
                r = t.max;
            return this._oriAngle(n) / this._end * (r - i) + i
        },
        _valueToAngle: function(n) {
            var t = this.options,
                i = t.min,
                r = t.max;
            return (n - i) / (r - i) * this._end + this._start
        },
        ...
        _getTooltipPos: function() {
            var n = this.options.circleShape,
                t, i = this.tooltip.outerHeight(),
                r = this.tooltip.outerWidth();
        ...
        _getTooltipValue: function(n) {
            var i = this.options.value,
                t;
            return this._rangeSlider ? (t = i.split(","), n) ? t[0] + " - " + t[1] : this._tooltipValue(t[0], 1) + " - " + this._tooltipValue(t[1], 2) : n ? i : this._tooltipValue(i)
        },
        ...
        _validateEndAngle: function() {
            ...
            return end = (this.isNumber(end) ? parseFloat(end) : 360) % 360, end <= start && (end += 360), end
        },
        ...
        _updateStartEnd: function() {
            var r = this.options,
                ...
                t = r.startAngle,
                i = r.endAngle;
            n != "full" && (n.indexOf("quarter") != -1 ? i = "+90" : n.indexOf("half") != -1 ? i = "+180" : n == "pie" && (i = "+270"), this.options.endAngle = i, n == "quarter-top-left" || n == "half-top" ? t = 0 : n == "quarter-top-right" || n == "half-right" ? t = 90 : n == "quarter-bottom-right" || n == "half-bottom" ? t = 180 : (n == "quarter-bottom-left" || n == "half-left") && (t = 270), this.options.startAngle = t)
        },
        ...
        _analyzeModelValue: function() {
            var f = this.options,
                ...
                o = typeof n == "string",
                i;
            n instanceof Array && (n = n.toString()), i = o ? n.split(",") : [n], this._rangeSlider ? u = o ? i.length >= 2 ? (r(i[0]) ? i[0] : t) + "," + (r(i[1]) ? i[1] : s) : r(i[0]) ? t + "," + i[0] : t + "," + t : r(n) ? t + "," + n : t + "," + t : o ? (e = i.pop(), u = r(e) ? parseFloat(e) : t) : u = r(n) ? parseFloat(n) : t, this.options.value = u
        },
        ...
        getBrowserName: function() {
            ...
            return !!window.opr && !!opr.addons || !!window.opera || t.indexOf(" OPR/") >= 0 ? n = "opera" : typeof InstallTrigger != "undefined" ? n = "firefox" : t.indexOf("MSIE ") > 0 || t.indexOf("Trident/") > 0 ? n = "ie" : window.StyleMedia ? n = "edge" : t.indexOf("Safari") != -1 && t.indexOf("Chrome") == -1 ? n = "safari" : (!window.chrome || !window.chrome.webstore) && t.indexOf("Chrome") == -1 || (n = "chrome"), n
        },
        ...
        setValue: function(n, t) {
            var i, r, u;
            this.isNumber(n) && (this.isNumber(t) && (i = this.options.sliderType, i == "range" ? (r = parseFloat(t), u = parseFloat(n), r == 1 ? n = u + "," + this._handle2.value : r == 2 && (n = this._handle1.value + "," + u)) : i == "default" && (this._active = t)), this._set("value", n))
        },
        disable: function() {
        ...
        var t = this,
            i = "rotate(" + n + "deg)";
        return t.css("-webkit-transform", i), t.css("-moz-transform", i), t.css("-ms-transform", i), t.css("-o-transform", i), t.css("transform", i), t
